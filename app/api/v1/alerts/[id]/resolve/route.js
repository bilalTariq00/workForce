...
export async function POST(req, { params }) {
  try {
    ...
    // Only Contracts Managers and Admin can resolve alerts
    ...
    // Resolve the alert
    await alert.resolve(session.user.id, validatedData.notes);
    ...
    return NextResponse.json(
      {
        ...
        error: {
          code: 'INTERNAL_ERROR',
          message: error.message || 'An error occurred while resolving alert',
        },
      },
      { status: 500 }
    );
