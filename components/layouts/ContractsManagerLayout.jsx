  ...
  const menuItems = [
    {
      ...
      href: '/contracts-manager/dashboard',
    },
    {
      title: 'Sites',
      icon: Building2,
    ...
    },
    {
      title: 'Alerts',
      icon: AlertTriangle,
      href: '/contracts-manager/alerts',
    },
    {
      title: 'Resource Allocation',
      icon: Users,
      href: '/contracts-manager/resource-allocation',
    },
    {
      title: 'Variations',
      icon: FileText,
      href: '/contracts-manager/variations',
    },
    {
      title: 'Reports',
      icon: FileText,
      href: '/contracts-manager/reports',
    },
    {
      title: 'Settings',
      icon: Settings,
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            {!collapsed && (
              <div className="min-w-0">
                <span className="font-semibold text-white block truncate">Contracts Manager</span>
              </div>
            )}
          </div>
          <Tooltip>
