 ...
 * 
 * Provides consistent sidebar navigation for Site Manager pages
 * Similar structure to HR DashboardLayout but with Site Manager specific menu items
 */
export default function SiteManagerLayout({ children, siteName }) {
              ...
              <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h1 className="text-lg sm:text-xl font-semibold text-white truncate">Site Manager</h1>
                    {siteName && (
                      <p className="text-xs text-white/80 hidden sm:block truncate">{siteName}</p>
                    )}
                  </div>
                </div>
              </div>
 ...
 */
function SidebarContent({ menuItems, session, siteName, onLogout, onItemClick, collapsed, onToggleCollapse }) {
  return (
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex h-16 items-center border-b border-white/20 px-3 lg:px-6 justify-between">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {!collapsed && (
              <div className="min-w-0">
                <span className="font-semibold text-white block truncate">Site Manager</span>
                {siteName && (
