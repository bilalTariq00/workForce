...
const TimesheetSchema = new Schema(
  {
    ...
    hours: [
      {
        ...
        // Reference to attendance record (legacy, for backward compatibility)
        attendanceId: {
          type: Schema.Types.ObjectId,
          ref: 'Attendance',
        },
        // Reference to attendance events (IN/OUT pairs)
        eventIds: [
          {
            type: Schema.Types.ObjectId,
            ref: 'AttendanceEvent',
    ...
    // Source of timesheet generation
    source: {
      type: String,
      enum: ['QR', 'MANUAL'],
      default: 'QR',
    ...
    adjustments: [
      {
        ...
        // Original hours before adjustment
        originalHours: {
          type: Number,
          required: true,
        },
    ...
    // Missing OUT events (flagged during generation)
    missingOutEvents: [
      {
        date: {
          type: Date,
